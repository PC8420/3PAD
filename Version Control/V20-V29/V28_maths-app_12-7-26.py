...
def profile_menu(window_type):
    ...
    profile_window.configure (bg="#fae6ff")
    profile_window.title("Maths Mania! | Gamemode Menu")

    main_profile_frame = ctk.CTkFrame(profile_window)
    main_profile_frame.grid(row=0, column=0, columnspan=3)
    
    banner_frame = Frame(main_profile_frame, width=500, height=150, bg="#590b93")
    banner_frame.grid(row=1, column=0, columnspan=3) 
    ...
    username_label = ctk.CTkLabel(main_profile_frame, font=(CUSTOM_FONT_2, 35), text = (f"{user_detail.username}'s Statistics"), height=40, width=1228, corner_radius=20, fg_color="#ecc8ff", text_color="#650892")
    username_label.grid(row=2, column=0, columnspan=3)
    #win_username_label = mode_canvas.create_window((29,94), anchor= "nw", window=username_label)

            # # ====================================================================================================================================================================================

            # # Questions answered widget
            # questions_answered_frame = ctk.CTkFrame(mode_canvas, height=100, width=445, corner_radius=20, fg_color="#dfb6ff")
            # win_questions_answered = mode_canvas.create_window((29,152), anchor= "nw", window=questions_answered_frame)

            # top_questions_answered_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = (f"{reading[3]}"), fg_color="#dfb6ff", text_color=COLOUR_1)
            # win_top_questions_answered_label = mode_canvas.create_window((50,168), anchor= "nw", window=top_questions_answered_label)

            # btm_questions_answered_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = ("Questions Answered"), fg_color="#dfb6ff", text_color="#650892")
            # win_btm_questions_answered_label = mode_canvas.create_window((50,168+30), anchor= "nw", window=btm_questions_answered_label)
