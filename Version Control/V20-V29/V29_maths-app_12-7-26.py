...
def profile_menu(window_type):
    ...
    profile_window.configure (bg="#aaaaaa")
    profile_window.title("Maths Mania! | Gamemode Menu")

    main_profile_frame = ctk.CTkFrame(profile_window, fg_color=COLOUR_4)
    main_profile_frame.pack(fill="both", expand=True)

    top_frame = ctk.CTkFrame(main_profile_frame, fg_color=COLOUR_5)
    top_frame.pack()

    bottom_frame = ctk.CTkFrame(main_profile_frame, fg_color=COLOUR_2)
    ...
    username_label = ctk.CTkLabel(top_frame, font=(CUSTOM_FONT_2, 35), text = (f"{user_detail.username}'s Statistics"), height=40, width=1228, corner_radius=20, fg_color="#ecc8ff", text_color="#650892")
    username_label.grid(row=2, column=0, columnspan=2, pady=(20,10), padx=20, sticky="nw")

    # ====================================================================================================================================================================================

    # Questions answered widget
    questions_answered_frame = ctk.CTkFrame(bottom_frame, height=100, width=400, corner_radius=20, fg_color="#dfb6ff")
    questions_answered_frame.grid(row=0, column=0, pady=10, padx=20, sticky="nw")

    top_questions_answered_label = ctk.CTkLabel(questions_answered_frame, font=(CUSTOM_FONT_2, 27), text = (f"{reading[3]}"), fg_color="#dfb6ff", text_color=COLOUR_1)
    top_questions_answered_label.place(x=25, y=25)
    
    btm_questions_answered_label = ctk.CTkLabel(questions_answered_frame, font=(CUSTOM_FONT_2, 27), text = ("Questions Answered"), fg_color="#dfb6ff", text_color="#650892")
    btm_questions_answered_label.place(x=25, y=55)

    # ====================================================================================================================================================================================

    aquestions_answered_frame = ctk.CTkFrame(bottom_frame, height=100, width=400, corner_radius=20, fg_color="#dfb6ff")
    aquestions_answered_frame.grid(row=1, column=0, pady=10, padx=20, sticky="nw")

    baquestions_answered_frame = ctk.CTkFrame(bottom_frame, height=100, width=400, corner_radius=20, fg_color="#dfb6ff")
    baquestions_answered_frame.grid(row=2, column=0, pady=10, padx=20, sticky="nw")

    cbaquestions_answered_frame = ctk.CTkFrame(bottom_frame, height=100, width=1240, corner_radius=20, fg_color="#dfb6ff")
    cbaquestions_answered_frame.grid(row=3, column=0, pady=10, padx=20, columnspan = 2, sticky="nw")

            # # ====================================================================================================================================================================================

            # # Accuracy widget
            # accuracy_frame = ctk.CTkFrame(mode_canvas, height=100, width=445, corner_radius=20, fg_color="#cb96fc")
            # win_accuracy_frame = mode_canvas.create_window((29,152+120), anchor= "nw", window=accuracy_frame)

            # top_accuracy_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = (f"{((correct/accuracy)*100):.2f}%"), fg_color="#cb96fc", text_color=COLOUR_1)
            # win_top_accuracy_label = mode_canvas.create_window((50,168+120), anchor= "nw", window=top_accuracy_label)

            # btm_accuracy_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = ("Accuracy"), fg_color="#cb96fc", text_color="#530892")
            # win_btm_accuracy_label = mode_canvas.create_window((50,168+30+120), anchor= "nw", window=btm_accuracy_label)

            # # ====================================================================================================================================================================================

            # # Combo widget
            # combo_frame = ctk.CTkFrame(mode_canvas, height=100, width=445, corner_radius=20, fg_color="#b97aff")
            # win_combo_frame = mode_canvas.create_window((29,152+240), anchor= "nw", window=combo_frame)

            # top_combo_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = (f"{reading[1]}"), fg_color="#b97aff", text_color=COLOUR_1)
            # win_top_combo_label = mode_canvas.create_window((50,168+240), anchor= "nw", window=top_combo_label)

            # btm_combo_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = ("Highest Combo"), fg_color="#b97aff", text_color="#400090")
            # win_btm_combo_label = mode_canvas.create_window((50,168+30+240), anchor= "nw", window=btm_combo_label)

            # # ====================================================================================================================================================================================

            # # Correct Answers widget
            # correct_answers_frame = ctk.CTkFrame(mode_canvas, height=100, width=445, corner_radius=20, fg_color="#dfb6ff")
            # win_correct_answers = mode_canvas.create_window((460+29,152), anchor= "nw", window=correct_answers_frame)

            # top_correct_answers_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = (f"{reading[3]}"), fg_color="#dfb6ff", text_color=COLOUR_1)
            # win_top_questions_answered_label = mode_canvas.create_window((460+50,168), anchor= "nw", window=top_correct_answers_label)

            # btm_correct_answers_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = ("Questions Answered"), fg_color="#dfb6ff", text_color="#650892")
            # win_btm_questions_answered_label = mode_canvas.create_window((460+50,168+30), anchor= "nw", window=btm_correct_answers_label)

            # # ====================================================================================================================================================================================

            # # Games Played widget
            # games_played_frame = ctk.CTkFrame(mode_canvas, height=100, width=445, corner_radius=20, fg_color="#cb96fc")
            # win_games_played_frame = mode_canvas.create_window((460+29,152+120), anchor= "nw", window=games_played_frame)

            # top_games_played_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = (f"{((correct/accuracy)*100):.2f}%"), fg_color="#cb96fc", text_color=COLOUR_1)
            # win_games_played_label = mode_canvas.create_window((460+50,168+120), anchor= "nw", window=top_games_played_label)

            # btm_games_played_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = ("Accuracy"), fg_color="#cb96fc", text_color="#530892")
            # win_btm_games_played_label = mode_canvas.create_window((460+50,168+30+120), anchor= "nw", window=btm_games_played_label)

            # # ====================================================================================================================================================================================

            # # Questions answered widget
            # high_score_frame = ctk.CTkFrame(mode_canvas, height=100, width=445, corner_radius=20, fg_color="#b97aff")
            # win_high_score_frame = mode_canvas.create_window((460+29,152+240), anchor= "nw", window=high_score_frame)

            # top_high_score_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = (f"{reading[1]}"), fg_color="#b97aff", text_color=COLOUR_1)
            # win_top_high_score_label = mode_canvas.create_window((460+50,168+240), anchor= "nw", window=top_high_score_label)

            # btm_high_score_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT_2, 27), text = ("Highest Combo"), fg_color="#b97aff", text_color="#400090")
            # win_btm_high_score_label = mode_canvas.create_window((460+50,168+30+240), anchor= "nw", window=btm_high_score_label)
