...
def game_menu(window_type, difficulty, game_type):
    ...
    login_title_label = Label(game_canvas, text= "", bg = COLOUR_7, font=(CUSTOM_FONT, 25, "bold italic"), fg=COLOUR_1, width = 40, height = 1)
