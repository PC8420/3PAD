...
def profile_menu(window_type):
    ...
    top_questions_answered_label = ctk.CTkLabel(questions_answered_frame, font=(CUSTOM_FONT_2, 27), text = (f"{reading[3]}"), fg_color="#cb96fc", text_color=COLOUR_1)
    top_questions_answered_label.pack(padx=(20,360), pady=(35,2))
    #win_questions_answered_label = mode_canvas.create_window((50,168), anchor= "nw", window=top_questions_answered_label)

    btm_questions_answered_label = ctk.CTkLabel(questions_answered_frame, font=(CUSTOM_FONT_2, 27), text = ("Questions Answered"), fg_color="#cb96fc", text_color="#530892")
    btm_questions_answered_label.pack(padx=(20,200), pady=(0,5))
