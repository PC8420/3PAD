...
# ====================================================================================================================================================================
    ...
    def check_answer(user_ans, raw_ans):
        ...
        combo_label.configure(fg_color = combo_bg_colour, text_color = combo_txt_colour_1)
...
# ====================================================================================================================================================================
    ...
    def disable_close():
        pass
    game_window.protocol("WM_DELETE_WINDOW", disable_close)
    ...
    item_image_3.icon = item_icon_3  # Storing reference so program doesn't delete/forget the image.
    ...
    item_image_5.icon = item_icon_5  # Storing reference so program doesn't delete/forget the image.
