...
def save_data(window_type, user_password, username):
    ...
    write_user_data(user_login_info, "w")
...
#====================================================================================================================================================================
    ...
    confirm_button = Button(user_button_frame, bg = COLOUR_4, text="CONFIRM LOGIN", font=(CUSTOM_FONT, 20, "bold"), fg = COLOUR_1, width = 20, command= lambda: (verify_account(login_window,password_entry, username_entry)))
