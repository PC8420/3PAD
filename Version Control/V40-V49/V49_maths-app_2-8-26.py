...
def score_menu(window_type, session_xp, combo, q_correct, total_questions, game_type, difficulty_type, game_session):
    ...
    score_bottom_frame = ctk.CTkFrame(score_main_frame, fg_color="#590b93", corner_radius=20)
...
# ====================================================================================================================================================================
    ...
    correct_label = ctk.CTkLabel(correct_frame, font=(CUSTOM_FONT, 25), text = "Correct", fg_color=COLOUR_22, text_color="#f7d5ff")
    ...
    question_label = ctk.CTkLabel(questions_frame, font=(CUSTOM_FONT, 25), text = "Question", fg_color=COLOUR_22, text_color="#f7d5ff")
    ...
    time_track_label = ctk.CTkLabel(time_frame, font=(CUSTOM_FONT, 25), text = "Time Left", fg_color=COLOUR_21, text_color="#f7d5ff")
    ...
    combo_label = ctk.CTkLabel(combo_frame, font=(CUSTOM_FONT, 25), text = "Combo", fg_color=COLOUR_22, text_color="#f7d5ff")
    ...
    score_label = ctk.CTkLabel(score_frame, font=(CUSTOM_FONT, 25), text = "Score", fg_color=COLOUR_22, text_color="#f7d5ff")
...
def mode_menu(window_type):
    ...
    mode_banner_label = ctk.CTkLabel(mode_banner_frame, font = (CUSTOM_FONT, 45), text = ("Mode Menu"), text_color="#f3e1ff", fg_color="#590b93")
    ...
    mode_info_label = ctk.CTkLabel(mode_canvas, font=(CUSTOM_FONT, 35), text = (f"Choose a maths skill to practice!"), height=45, width=919, corner_radius=20, fg_color="#ecc8ff", text_color="#650892")
...
#====================================================================================================================================================================
    ...
    # Adds a banner at the top of the screen
    banner_label = ctk.CTkLabel(banner_frame, font = (CUSTOM_FONT, 45), text = ("Profile Menu"), text_color="#f3e1ff", fg_color="#590b93", corner_radius=0)
    ...
    username_label = ctk.CTkLabel(top_frame, font=(CUSTOM_FONT, 35), text = (f"{user_detail.username}'s Statistics"), height=40, width=1250, corner_radius=20, fg_color="#ecc8ff", text_color="#650892")
...
def leaderboard_menu(window_type):
    ...
    # Adds a banner at the top of the screen
    leaderboard_banner_label = ctk.CTkLabel(leaderboard_banner_frame, font = (CUSTOM_FONT, 45), text = "Leaderboard Menu", text_color="#f3e1ff", fg_color="#590b93")
...
# Main window settings
    ...
    main_window.configure (fg_color="#584353")
...
# Main window widgets with custom images
    ...
    mode_banner_frame = ctk.CTkFrame(main_canvas, width=530, height=150, fg_color="#590b93")
    mode_banner_frame.pack(fill="x")

    # Adds a banner at the top of the screen
    title_label = ctk.CTkLabel(mode_banner_frame, image = title, text="", fg_color="#590b93")
    ...
    play_button = ctk.CTkButton(main_canvas, fg_color = "#69d634", hover_color=COLOUR_7, corner_radius=0, text="", image = play, width = 640, height = 400, command = lambda: mode_menu(main_window))    
    play_button.place(x=20, y=200)

    leaderboard_button = ctk.CTkButton(main_canvas, fg_color = "#2aa8cc", hover_color=COLOUR_7, corner_radius=0, text="", image = leaderboard, command=lambda: leaderboard_menu(main_window))    
    leaderboard_button.place(x=700, y=200)

    profile_button = ctk.CTkButton(main_canvas, fg_color = "#bc3a68", hover_color=COLOUR_19, corner_radius=0, text="", image = settings, command= lambda: profile_menu(main_window))    
...
#====================================================================================================================================================================
    ...
    mode_banner_frame = ctk.CTkFrame(login_canvas, width=530, height=150, fg_color="#590b93")
    mode_banner_frame.pack(fill="x")

    # Adds a banner at the top of the screen
    mode_banner_label = ctk.CTkLabel(mode_banner_frame, font = (CUSTOM_FONT, 45), text = ("Login Menu"), text_color="#f3e1ff", fg_color="#590b93")
...
#====================================================================================================================================================================
    ...
    username_label = ctk.CTkLabel(username_frame, fg_color = COLOUR_6, text="Username", font=(CUSTOM_FONT, 30), width = 200, height = 50, corner_radius=20)
...
#====================================================================================================================================================================
    ...
    password_label = ctk.CTkLabel(password_frame, fg_color = COLOUR_6, text="Password", font=(CUSTOM_FONT, 30), width = 200, height = 50, corner_radius=20)
