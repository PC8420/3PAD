...
# ====================================================================================================================================================================
    ...
    def test():
        game_canvas.itemconfig(game_canvas_bg, image=img_2)
        game_canvas.image = img_2
    ...
    img_2 = tk.PhotoImage(file = "images/mode_bg.png")
    ...
    correct_frame = ctk.CTkFrame(game_middle_frame, width=164, height=71, corner_radius=20, fg_color=COLOUR_22)
    correct_frame.grid(row=0, column=0, pady=10, padx=13, sticky="nw")
    
    stat_title_label = ctk.CTkLabel(correct_frame, font=(CUSTOM_FONT_2, 40), text = f"0/{QUESTIONS_PER_GAME}", fg_color=COLOUR_22, text_color=COLOUR_3)
    stat_title_label.place(x=19, y=24)

    stat_track_label = ctk.CTkLabel(correct_frame, font=(CUSTOM_FONT_2, 25), text = "Correct", fg_color=COLOUR_22, text_color="#f7d5ff")
    stat_track_label.place(x=19, y=4)
    ...
    item_image.place(x = 108, y = 30)
    item_image.icon = item_icon  # Storing reference so program doesn't delete/forget the image.
    #====================================================================================================================================================================

    questions_frame = ctk.CTkFrame(game_middle_frame, width=164, height=71, corner_radius=20, fg_color=COLOUR_22)
    questions_frame.grid(row=0, column=1, pady=10, padx=13, sticky="nw")
    
    stat_title_label_2 = ctk.CTkLabel(questions_frame, font=(CUSTOM_FONT_2, 40), text = f"0/{QUESTIONS_PER_GAME}", fg_color=COLOUR_22, text_color=COLOUR_3)
    stat_title_label_2.place(x=19, y=24)

    stat_track_label_2 = ctk.CTkLabel(questions_frame, font=(CUSTOM_FONT_2, 25), text = "Question", fg_color=COLOUR_22, text_color="#f7d5ff")
    stat_track_label_2.place(x=19, y=4)
    ...
    combo_label = ctk.CTkLabel(combo_frame, font=(CUSTOM_FONT_2, 40), text = f"0", fg_color=COLOUR_22, text_color=COLOUR_3)
    combo_label.place(x=19, y=24)

    stat_combo_label = ctk.CTkLabel(combo_frame, font=(CUSTOM_FONT_2, 25), text = "Combo", fg_color=COLOUR_22, text_color="#f7d5ff")
    stat_combo_label.place(x=19, y=4)
    ...
    score_label = ctk.CTkLabel(score_frame, font=(CUSTOM_FONT_2, 40), text = f"0", fg_color=COLOUR_22, text_color=COLOUR_3)
    score_label.place(x=19, y=24)

    stat_score_label = ctk.CTkLabel(score_frame, font=(CUSTOM_FONT_2, 25), text = "Score", fg_color=COLOUR_22, text_color="#f7d5ff")
    stat_score_label.place(x=19, y=4)
    ...
    question_label = ctk.CTkLabel(game_bottom_frame, text= "", fg_color = COLOUR_22, font=(CUSTOM_FONT_2, 40), text_color=COLOUR_1, width=1240, height=135, corner_radius=20)
