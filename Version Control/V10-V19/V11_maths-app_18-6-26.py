...
# Import images
    ...
    quit_button = Button(mode_canvas, bg = COLOUR_1, text="X", font=(CUSTOM_FONT, 30, "bold"), fg = "white", command = lambda: quit_program(mode_window), image = quit)    
    win_quit_button = mode_canvas.create_window((1115,30), anchor= "nw", window=quit_button)
    quit_button.image = quit

    addition_button = Button(mode_canvas, bg = COLOUR_1, text="PLAY", font=(CUSTOM_FONT, 30, "bold"), fg = "white", image = addition_img, command = lambda: print("1"))    
    win_addition_button = mode_canvas.create_window((80,205), anchor= "nw", window=addition_button)
